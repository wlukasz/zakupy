      ...
      lingos: [
        {
          ...
          allShops: 'All Shops',
          deleteAllMsg1:
            'Warning: OK will permanently remove all items. Push Cancel to avoid',
          deleteAllMsg2:
            'Note: To remove just one item Cancel this pop-up and swipe item to the left.',
          removeItem: 'Remove',
        ...
        },
        {
          ...
          deleteAllMsg1:
            'Uwaga: OK usunie wszystkie towary z listy. Cancel anuluje komendę.',
          deleteAllMsg2:
            'Notka: Aby usunąć jeden towar anuluj tę komendę i przesuń wybrany towar w lewo.',
          removeItem: 'Usuń',
